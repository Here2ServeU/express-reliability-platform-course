...
The V10 UI keeps the same V2 regulated readiness console and evolves it with healthcare telemetry, robotics/IoMT status, and predictive remediation checks. Students should experience this as the same platform growing, not as a separate app.

### What the V10 UI Does

The V10 `index.html` is the healthcare reliability intelligence console. It extends the platform into hospital operations by evaluating telemetry, robot or IoMT status, and remediation maturity.
...
Use the V10 UI to show how the platform can support advanced healthcare scenarios. Students can demonstrate how telemetry from hospital systems or robotic workflows can become operational evidence and remediation guidance.
